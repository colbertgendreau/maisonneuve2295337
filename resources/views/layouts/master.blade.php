                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="#">Connection</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text"> 1245 Route Labas, <br>
                                Cityville</p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text">+420 6969 <br>
                                reservation@ici.com</p>
                        </div>
                    </div>
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('etudiant.create')}}">Ajouter</a></li>
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p class="newsletter_text">Recevoir les actualités</p>
                        </div>
                    </div>
                </div>
            </div>
